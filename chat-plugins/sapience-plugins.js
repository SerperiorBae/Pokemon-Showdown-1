...
exports.commands = {
	...
	animalshelp: ['|html|Animals Plugin by Murdering<br>' +
		...
		'<li>/animals help - Displays this help box.</li></ul>'
	],
	...
	giphy: function (target, room, user) {
		...
		let tarId = toId(target);
		let self = this;
		let banlist = ['vagina', 'anal', 'penis', 'gaysex', 'yaoi', 'yuri', 'tits', 'breasts', 'boobs', 'boobies', 'cunny', 'porn', 'ass', 'intercourse', 'dildo', 'sextoy', 'bestiality', 'r34', 'booty', 'sex', 'naked', 'nude', 'nudes', 'shagging', 'fornicating', 'twerking', 'pornographic'];
		if (banlist.includes(tarId)) return this.errorReply('Sorry you have tried to use a banned word and thus returned this error. Don\'t you feel foolish?');
		let reqOpt = {
			hostname: 'api.giphy.com', // Do not change this
			path: '/v1/gifs/random?api_key=dc6zaTOxFJmzC&tag=' + tarId,
			method: 'GET',
	...
	/****************************************
	 * Events Plugin by RoboPhill & Murdering *
	 ****************************************/
