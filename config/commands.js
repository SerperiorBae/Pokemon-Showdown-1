...
var commands = exports.commands = {
	...
	meme: function(target, room, user) {
		...
		if (!this.canBroadcast()) return;
		this.sendReplyBox('<font size="4" color="#FF24E5"><b>Kakuja Rules</b></font><br><font size="2" color="#3DA5FF">1.) Try to limit the caps unless we are singing.<br>2.) Staff members are not to warn, mute, or lock any other staff without an admin\'s permission (unless of course they break a global rule)<br>3.) Admins are the only ones who may ban staff or deliver demotions or promotions.<br>4.) Anyone who mentions nudes will receive an instant lock. If they mention it again, they will be banned, no questions asked.<br>5.) Parukia members are on permanent watch, except for Nick and Vile.<br>6.) All warnings, mutes, and locks should be delivered maturely and for warranted reasons, not personal reasons.<br>7.) Kakuja has made some changes to typings, type effectiveness, moves, movesets, abilities, and stats. If you have any questions about the changes, please feel free to click on the Kakuja Pokemon button in the roomintro or message an admin.<br>8.) There is a fine line between constructive criticism and disrespect.<br>9.) Staff, please remember that locks are a final measure for discipline, and to deliver warns and mutes first, lock only if the behaviour continues.<br>10.) Be nice. ');
	},
		suicune: function(target, room, user) {
		if (!this.canBroadcast()) return;
		this.sendReplyBox('<table><td bgcolor="#303030" width="900"><br><table><td><span class="col numcol">Ubers&nbsp;</span></td><td> <span class="col iconcol"><img src="http://73.10.53.242:8000/avatars/77e6210990.png" width="100" height="75" align="bottom"></span></td><td><font size="3">&nbsp;&nbsp;Charlotte&nbsp;&nbsp;&nbsp;&nbsp;</font></td><td><img src="http://play.pokemonshowdown.com/sprites/types/Water.png" width="32" height="14"><img src="http://play.pokemonshowdown.com/sprites/types/Dark.png" width="32" height="14">&nbsp;&nbsp;&nbsp;</td><td><font size="2" width="100%">Serene Grace &nbsp;&nbsp;<i> Eternal Beauty</i></td></table><table><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td><td>&nbsp;&nbsp;<font size="1">HP</font><br><font size="1">&nbsp;100</font></td><td>&nbsp;<font size="1">Atk</font><br><font size="1">&nbsp;&nbsp;75</font></td><td>&nbsp;<font size="1">Def</font><br><font size="1">&nbsp;110</font></td><td>&nbsp;<font size="1">SpA</font><br><font size="1">&nbsp;&nbsp;100</font></td><td>&nbsp;<font size="1">SpD</font><br><font size="1">&nbsp;&nbsp;110</font></td><td>&nbsp;<font size="1">Spe</font><br><font size="1">&nbsp;&nbsp;90</font></td><td>&nbsp;&nbsp;<font size="1">BST</font><br><font size="1">&nbsp;&nbsp;&nbsp;585</font></td></table><table><td><font size="1" color="grey">Dex#:</font> <font size="1"> 245 | <font size="1" color="grey">Height:</font> <font size="1">1.57 m | <font size="1" color="grey">Weight:</font> <font size="1">58 kg <i>(80 BP)</font> | <font size="1" color="grey">Dex Colour:</font> <font size="1"> Blue | <font size="1" color="grey">Egg Group(s):</font> <font size="1">Pure, Perfection | <font size="1" color="grey">Does Not Evolve</td></table></table>');
	},
		serperior: function(target, room, user) {
		if (!this.canBroadcast()) return;
		this.sendReplyBox('<table><td bgcolor="#303030" width="900"><br><table><td><span class="col numcol">Ubers&nbsp;</span></td><td> <span class="col iconcol"><img src="http://73.10.53.242:8000/avatars/p3kenM2.png" width="80" height="80" align="bottom"></span></td><td><font size="3">&nbsp;&nbsp;Kevin&nbsp;&nbsp;&nbsp;&nbsp;</font></td><td><img src="http://play.pokemonshowdown.com/sprites/types/Grass.png" width="32" height="14">&nbsp;&nbsp;&nbsp;</td><td><font size="2" width="100%">Analytic &nbsp;&nbsp;<i> Defiant</i></td></table><table><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td><td>&nbsp;&nbsp;<font size="1">HP</font><br><font size="1">&nbsp;&nbsp;75</font></td><td>&nbsp;<font size="1">Atk</font><br><font size="1">&nbsp;&nbsp;75</font></td><td>&nbsp;<font size="1">Def</font><br><font size="1">&nbsp;&nbsp;95</font></td><td>&nbsp;<font size="1">SpA</font><br><font size="1">&nbsp;&nbsp;100</font></td><td>&nbsp;<font size="1">SpD</font><br><font size="1">&nbsp;&nbsp;&nbsp;95</font></td><td>&nbsp;<font size="1">Spe</font><br><font size="1">&nbsp;113</font></td><td>&nbsp;&nbsp;<font size="1">BST</font><br><font size="1">&nbsp;&nbsp;553</font></td></table><table><td><font size="1" color="grey">Dex#:</font> <font size="1"> 497 | <font size="1" color="grey">Height:</font> <font size="1">2.01 m | <font size="1" color="grey">Weight:</font> <font size="1">69 kg <i>(80 BP)</font> | <font size="1" color="grey">Dex Colour:</font> <font size="1"> Green | <font size="1" color="grey">Egg Group(s):</font> <font size="1">Snake, Sociopath | <font size="1" color="grey">Does Not Evolve</td></table></table>');
	},
		...
		if (!this.canBroadcast()) return;
		this.sendReplyBox('<table><td bgcolor="#303030" width="900"><br><table><td><span class="col numcol">Ubers&nbsp;</span></td><td> <span class="col iconcol"><img src="http://73.10.53.242:8000/avatars/93jm23N.png" width="80" height="80" align="bottom"></span></td><td><font size="3">&nbsp;&nbsp;Phil&nbsp;&nbsp;&nbsp;&nbsp;</font></td><td><img src="http://play.pokemonshowdown.com/sprites/types/Psychic.png" width="32" height="14"<img src="http://play.pokemonshowdown.com/sprites/types/Fighting.png" width="32" height="14">&nbsp;&nbsp;&nbsp;</td><td><font size="2" width="100%">Reckless &nbsp;&nbsp;<i> Bulletproof</i></td></table><table><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td><td>&nbsp;&nbsp;<font size="1">HP</font><br><font size="1">&nbsp;&nbsp;68</font></td><td>&nbsp;<font size="1">Atk</font><br><font size="1">&nbsp;&nbsp;125</font></td><td>&nbsp;<font size="1">Def</font><br><font size="1">&nbsp;&nbsp;65</font></td><td>&nbsp;<font size="1">SpA</font><br><font size="1">&nbsp;&nbsp;115</font></td><td>&nbsp;<font size="1">SpD</font><br><font size="1">&nbsp;&nbsp;&nbsp;65</font></td><td>&nbsp;<font size="1">Spe</font><br><font size="1">&nbsp;80</font></td><td>&nbsp;&nbsp;<font size="1">BST</font><br><font size="1">&nbsp;&nbsp;518</font></td></table><table><td><font size="1" color="grey">Dex#:</font> <font size="1"> 475 | <font size="1" color="grey">Height:</font> <font size="1">1.6 m | <font size="1" color="grey">Weight:</font> <font size="1">52 kg <i>(80 BP)</font> | <font size="1" color="grey">Dex Colour:</font> <font size="1"> White | <font size="1" color="grey">Egg Group(s):</font> <font size="1">Phil, Slut | <font size="1" color="grey">Does Not Evolve</td></table></table>');
	},
