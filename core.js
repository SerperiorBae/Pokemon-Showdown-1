...
emoticons: {
	/*
        ...
        'O_O': 'http://i.imgur.com/kixjIOR.gif',
        ...
        'troLL': 'http://www.ps4news.de/forum/public/style_emoticons/default/trollface%20.gif',
        '^_^': 'http://i.imgur.com/MiwopCh.png',
	'challengeaccepted': 'http://i.imgur.com/Qmv32c7.png',
	'fuckyeah': 'http://i.imgur.com/kd7oeiX.png',
	'gj': 'http://i.imgur.com/FChx5bz.png',
	'justin': 'http://i.imgur.com/uRJ4yNR.png',
	'gusta': 'http://i.imgur.com/V3exz0t.png',
	'miley': 'http://i.imgur.com/cee078K.png',
	'nicki': 'http://i.imgur.com/7s6zezZ.png',
    ...
    processChatData: function (user, room, connection, message) {
		...
		return;
			...
			return false;
        		...
        		room.add('|raw|<div class="chat"><button class="astext" name="parseCommand" value="/user '+ Tools.escapeHTML(user.name) +'" target="_blank"><strong><font color="' + hashColor(user.userid)+'"><small>' + user.group + '</small><span class="username" data-name="' + user.group + Tools.escapeHTML(user.name) + '">' + Tools.escapeHTML(user.name) + '</span>:</font></strong></button> <em class="mine">' + message + '</em></div>');
        		return false;
        	}
	}
},        
