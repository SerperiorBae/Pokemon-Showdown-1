exports.BattleMovedex = {
	...
	"remembrance": {
		...
		basePower: 30,
		category: "Physical",
		desc: "Hits two to five times. Has a 1/3 chance to hit two or three times, and a 1/6 chance to hit four or five times. If one of the hits breaks the target's substitute, it will take damage for the remaining hits. If the user has the Ability Skill Link, this move will always hit five times. Has a 10% chance to flinch the target",
		shortDesc: "Hits 2-5 times in one turn. 10% chance to flinch the target.",
		id: "remembrance",
		isViable: true,
		name: "Remembrance",
		pp: 10,
	...
	"soulconsumption": {
		...
		basePower: 0,
		category: "Status",
		desc: "Raises the user's Special Attack and Special Defense by 2 stages, but drops the user's Attack and Defense by 1 stage.",
		shortDesc: "Boosts the user's Sp. Atk and Sp. Def by 2, drops Atk and Def by 1.",
		id: "soulconsumption",
		isViable: true,
